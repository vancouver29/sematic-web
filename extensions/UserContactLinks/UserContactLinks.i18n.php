...
$messages['gsw'] = array(
	'usercontactlink-baduser' => 'falscher Benutzername',
	'usercontactlinks-desc' => 'Macht s megli, Benutzername eifach mit ^^^Benutzer^^^ yyzsetze',
);
...
$messages['ja'] = array(
	...
	'usercontactlinks-desc' => '^^^user^^^という構文を使用して、他の利用者名を簡単に一貫して追加する機能を提供する',
);
 ...
 */
$messages['ka'] = array(
	'usercontactlink-baduser' => 'არასწორი მომხმარებლის სახელი',
);
...
$messages['ko'] = array(
	...
	'usercontactlinks-desc' => '간단하고 일관되게 ^^^사용자^^^ 문법을 사용하여 다른 사용자 이름을 추가하는 기능을 제공',
);
